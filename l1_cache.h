// 4KB 4-way set-associative L1 cache
#define NUM_L1_CACHE_WAYS 4
#define NUM_L1_CACHE_SETS 32
#define NUM_L1_CACHE_BLOCK_SIZE 32           // in bytes
  
#define NUM_L1_CACHE_SET_INDEX_BITS 5        // L1 cache index bits -- No. of bits required to address a particular set/ total 32 sets -- log_2(32)
...
#define NUM_L1_CACHE_MAIN_TAG_BITS 11        // L1 cache tag bits -- (No. of bits in frame address - L1 cache index bits - L1 cache offset bits - L1 cache halt tag bits)       
