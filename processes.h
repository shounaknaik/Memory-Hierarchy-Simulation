...
#define MAX_PAGE_FAULT_FREQUENCY 0.0000025 // 0.00025%
...
typedef struct {
    ...
    int num_total_pages;               // Total number of pages held by this process
} PCB;
...
void prepaging_function (PCB* pcb_array, int num_processes);                  // Loads the first 2 pages of all READY processes
