...
void update_L1_TLB (L1_TLB* l1_tlb, unsigned int pg_num, unsigned int frame_num, unsigned int shared_bit); // Update L1 TLB with the entry acquired via page table walk - placement / random replacement
void update_L2_TLB (L2_TLB* l2_tlb, unsigned int pg_num, unsigned int frame_num, unsigned int shared_bit); // Update L2 TLB with the entry acquired via page table walk - placement / LRU replacement
